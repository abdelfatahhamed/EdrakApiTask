...
namespace EdrakApiTask
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddDbContext<EdrakApiTaskDbContext>(
                options => options.UseSqlServer(builder.Configuration.GetConnectionString("EdrakApiTask"))
                );
            ...
            builder.Services.AddIdentity<ApplicationUser, IdentityRole>(options =>
            {
                ...
                .AddEntityFrameworkStores<EdrakApiTaskDbContext>();
            ...
            #region Managers
            builder.Services.AddScoped<IOrderCustomer, OrderCustomer>();
            builder.Services.AddScoped<IProductCustomer, ProductCustomer>();
            #endregion
